...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->справочнаяИнформацияToolStripMenuItem = (gcnew System::Windows::
			...
			chartArea2->AxisX->Title = L"Ось X";
			...
			legend2->Title = L"Цвета графиков";
			...
			series10->LegendText = L"График 2";
			...
			// 
			this->менюToolStripMenuItem->DropDownItems->AddRange(
			...
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this,
				&MyForm::выходToolStripMenuItem_Click);
			// 
			// groupBox1
			// 
			...
			this->справочнаяИнформацияToolStripMenuItem->Click += gcnew System::EventHandler(this, 
				&MyForm::справочнаяИнформацияToolStripMenuItem_Click);
			// 
			...
			this->выходToolStripMenuItem1->Click += gcnew System::EventHandler(this, 
				&MyForm::выходToolStripMenuItem_Click);
			// 
			// MyForm
			// 
